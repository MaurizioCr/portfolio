        ...
        <>
            ...
            <Container className="mt-5">
                <AnimatedRow0>
                    ...
                    <Col className="col-12 col-md-6 bg-white fit py-5 rounded align-self-center border border-5">
                ...
                <Col className="d-flex flex-wrap black justify-content-center rounded p-5 border-black border-5 bg-danger">
                ...
                <AnimatedRow2 id="Progetti" className="py-4 px-4 mt-5 text-center mb-5 black border-black border-5 rounded bg-warning">
                    ...
                    <Col  className="col-6 border rounded blue">
